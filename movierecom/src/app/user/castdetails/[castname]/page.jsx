  ...
  return (
    <div>
        ...
        <div>
          ...
          <p
            className={`${lancelot.className} "title text-7xl text-center text-white mt-12"`}
          >
            Cast Details
          </p>
          <div className="castdetails flex flex-col items-center text-white">
            ...
            <div className="dets w-[95%]  bg-zinc-800 p-10 rounded-md mt-12">
              <p
                className={`${poppins.className} name text-4xl mb-5 font-bold`}
              >
                Name: {name}
              </p>
              <p className={`bio mt-5 text-lg ${clamp ? 'line-clamp-3':'line-clamp-none'}`}>{bio}</p>
              <Button onClick={()=>{clamp ? setClamp(false):setClamp(true)}}>{clamp ? 'Read More':'Read Less'}</Button>
          ...
          <div className="movies mt-12">
            <p
              className={`${lancelot.className} "title text-5xl underline text-center text-red-500 mt-40`}
            >
              Recommended Movies
            </p>
