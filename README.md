...
3. Add your unique clientId and secret in the .env file which is already created.
4. Uses TMDB API for fetching details like poster,cast details,etc.
5. Make sure to create your account on TMDB and use your API Key. Edit the .env file in the server folder.
